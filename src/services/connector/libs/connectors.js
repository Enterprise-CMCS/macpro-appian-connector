export const connectors = [
  {
    ...
    config: {
      ...
      query: `SELECT CAST(PCKG_ID AS NUMERIC(38,0)) AS PCKG_ID, ${process.env.legacyschema}.MCP_SPA_PCKG.* FROM ${process.env.legacyschema}.MCP_SPA_PCKG ORDER BY MCP_SPA_PCKG.PCKG_ID`,
